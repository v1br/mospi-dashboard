...
import type { DualLineChartProps } from "../../types/types";

const DualLineChart: React.FC<DualLineChartProps> = ({
    className, labels, datasets, indexAxis, xlabel, ylabel, ylabel2, legendDisplay, legendPosition
}) => {
    ...
    [xlabel, ylabel, ylabel2, indexAxis, legendPosition],
    );
